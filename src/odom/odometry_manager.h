...
namespace cocolic
{
  ...
  public:
    ...
    void RunBag(pcl::PointCloud<pcl::PointXYZI> &map_cloud);
  ...
  protected:
    ...
    void SolveLICO(pcl::PointCloud<pcl::PointXYZI> &map_cloud);

    void ProcessLICData(pcl::PointCloud<pcl::PointXYZI> &map_cloud);
  ...
  private:
    ...
    double m_minumum_rgb_pts_size;
    double m_recent_visited_voxel_activated_time;
    int m_pub_pt_minimum_views;
